    ...
    <div class="flex items-center space-x-4 p-10 border-b-4 border-gray-200">
        <div id="logo" class="relative cursor-pointer">
            ...
            <div id="navLinks" class="absolute left-full top-0 flex space-x-4 opacity-0 translate-x-[-100%] transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:translate-x-0">
                <a href="{{ route('home') }}" class="text-black text-lg hover:text-[#065f46] transition-transform transform hover:scale-180">Home</a>
                <a href="{{ route('creatteam') }}" class="text-black text-lg hover:text-[#065f46] transition-transform transform hover:scale-180">Create a team</a>
                <a href="{{ route('services') }}" class="text-black text-lg hover:text-[#065f46] transition-transform transform hover:scale-180">Services</a>
                <a href="{{ route('contact') }}" class="text-black text-lg hover:text-[#065f46] transition-transform transform hover:scale-180">Contact</a>
                @auth
